    ...
    if (currentUser) {
        ...
        if (authButtons) {
            authButtons.innerHTML = `
                ...
                <a href="profile.html" class="btn" style="padding: 8px 15px; font-size: 0.9rem;">Mi Perfil</a>
        ...
        if (authButtons) {
            authButtons.innerHTML = `
                <a href="login.html" class="btn" style="padding: 8px 15px; font-size: 0.9rem;">Iniciar Sesión</a>
                <a href="register.html" class="btn btn-outline" style="padding: 8px 15px; font-size: 0.9rem;">Registrarse</a>
            `;
        }
    }
}
